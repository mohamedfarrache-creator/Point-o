  ...
  @override Widget build(BuildContext context) {
    ...
    return ListView(padding: const EdgeInsets.all(20), children: [
      ...
      Form(key: _formKey, child: Column(children: [
        TextFormField(controller: _daily, keyboardType: TextInputType.number, decoration: const InputDecoration(labelText: 'Durée quotidienne standard', suffixText: 'heures', prefixIcon: Icon(Icons.schedule)), validator: _validHours),
        const SizedBox(height: 18),
        TextFormField(controller: _target, keyboardType: TextInputType.number, decoration: const InputDecoration(labelText: 'Objectif mensuel', suffixText: 'heures', prefixIcon: Icon(Icons.flag_outlined)), validator: _validHours),
      ])),
      ...
      const SizedBox(height: 24), const Text('Les données de pointage restent enregistrées localement sur cet appareil.', style: TextStyle(color: Colors.black54)),
    ]);
  }
